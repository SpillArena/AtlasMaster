...
// fylker = skog/fjell, storbyer = flaggblå natt-by — nordisk, ikke tilfeldig
          ...
          <li key={c.id}>
            ...
            >
              ...
              <div className="relative flex flex-col items-center gap-2 px-3 text-center text-white sm:gap-3">
                ...
                >
                  <Icon name={c.icon} className="h-14 w-14 sm:h-20 sm:w-20 md:h-24 md:w-24" />
                </motion.span>
                <span className="font-display text-3xl font-extrabold tracking-tight drop-shadow-md sm:text-4xl md:text-5xl">
                  {t(c.labelKey)}
                </span>
